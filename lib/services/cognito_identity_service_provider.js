...
class CognitoIdentityServiceProvider extends BaseService {
  ...
  createUserPool(opts, req, res) {
    ...
    this.createItem(['CognitoIdentityServiceProvider', 'userPools', req.body.Id], req.body, function(err, data) {
      res.json({
        UserPool: data
      })
    })
  ...
  updateUserPool(opts, req, res) {
    ...
    this.updateItem(['CognitoIdentityServiceProvider', 'userPools', poolId], req.body, function(err, data) {
      res.json({
        UserPool: data
      })
    })
  ...
  createUserPoolClient(opts, req, res) {
    ...
    this.createItem(['CognitoIdentityServiceProvider', 'userPoolClients', req.body.ClientId], req.body, function(err, data) {
      res.json({
        UserPoolClient: data
      })
    })
  ...
  updateUserPoolClient(opts, req, res) {
    ...
    this.updateItem(['CognitoIdentityServiceProvider', 'userPoolClients', poolId], req.body, function(err, data) {
      res.json({
        UserPoolClient: data
      })
    })
