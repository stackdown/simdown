...
class CognitoIdentityServiceProvider extends BaseService {
  ...
  signUp(opts, req, res) {
    ...
    this.createItem(['CognitoIdentityServiceProvider', 'userPools', data.UserSub], data, (err, data) => {
  ...
  initiateAuth(opts, req, res) {
    ...
    res.json({
      ...
      ChallengeParameters: {
        ...
        SECRET_BLOCK: "secretblockdata",
        SRP_B: "moresecretdata",
        USERNAME: data.AuthParameters.USERNAME,
        USER_ID_FOR_SRP: data.AuthParameters.USERNAME
      }
    })
  }
