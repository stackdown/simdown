...
class APIGateway extends BaseService {
  handlers() {
    return {
      ...
      "POST /restapis/:restApiId/stages": this.getHandler('PostStages'),
      "GET /restapis/:restApiId/stages/:stageId": this.getHandler('GetStage'),
      "PATCH /restapis/:restApiId/stages/:stageId": this.getHandler('UpdateStage'),
      "DELETE /restapis/:restApiId/stages/:stageId": this.getHandler('DeleteStage'),
